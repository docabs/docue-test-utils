...
import { defineComponent, h, nextTick, Fragment } from 'docuejs'
import { mount, DocueWrapper } from '../src'
// import SuspenseComponent from './components/Suspense.docue'
// import ParentComponent from './components/ParentComponent.docue'
// import MultipleRootRender from './components/MultipleRootRender.docue'
...
describe('findAll', () => {
  ...
  //   it('finds itself on Docue wrapper', () => {
  //     const wrapper = mount(ParentComponent)
