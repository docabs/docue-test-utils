...
import { defineComponent, h, ref } from 'docuejs'
  ...
  describe('errors', () => {
    it('throws error if options contains a target value', () => {
      const expectedErrorMessage =
        '[docue-test-utils]: you cannot set the target value of an event. See the notes section of the docs for more details—https://vue-test-utils.vuejs.org/api/wrapper/trigger.html'
