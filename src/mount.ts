import { ComponentPublicInstance, DefineComponent, VNode } from 'docuejs'
import type {
  ComponentExposed,
  ComponentProps,
  ComponentSlots
} from 'docue-component-type-helpers'
import { createInstance } from './createInstance'
import { MountingOptions } from './types'
import { trackInstance } from './utils/autoUnmount'
import { DocueWrapper } from './docueWrapper'
import { createDocueWrapper } from './wrapperFactory'
...
export function mount(
  ...
  const wrapper = createDocueWrapper(app, appRef, setProps)
