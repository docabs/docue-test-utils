...
import {
  ...
  unwrapLegacyDocueExtendComponent
} from './utils/docueCompatSupport'
...
function getInstanceOptions(
  ...
  if (options.methods) {
    console.warn(
      "Passing a `methods` option to mount was deprecated on Docue Test Utils v1, and it won't have any effect on v2. For additional info: https://docue-test-utils.docuejs.org/upgrading-to-v1/#setmethods-and-mountingoptions-methods"
    )
...
export function createInstance(
  ...
  const originalComponent = unwrapLegacyDocueExtendComponent(inputComponent)
  ...
  // Docue's reactivity system will cause a rerender.
  ...
  //         // due to https://github.com/docuejs/core/commit/f73925d76a76ee259749b8b48cb68895f539a00f#diff-ea4d1ddabb7e22e17e80ada458eef70679af4005df2a1a6b73418fec897603ceR404
  //         // introduced in Docue v3.2.45
