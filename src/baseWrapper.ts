...
import { createDOMWrapper, createDocueWrapper } from './wrapperFactory'
...
{
  protected readonly wrapperElement: DocueNode<ElementType>
  protected abstract getRootNodes(): DocueNode[]
