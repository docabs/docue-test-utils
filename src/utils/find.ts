...
import { unwrapLegacyDocueExtendComponent } from './docueCompatSupport'
...
export function matches(
  ...
  const selector = unwrapLegacyDocueExtendComponent(rawSelector)

  // do not return none Docue components
